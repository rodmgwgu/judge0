...
[
  ...
  {
    id: 63,
    name: "JavaScript (Node.js 22.18.0)",
    is_archived: false,
    source_file: "script.js",
    run_cmd: "/usr/local/node-22.18.0/bin/node script.js"
  },
  # {
  #   id: 64,
  #   name: "Lua (5.3.5)",
  ...
  },
  {
    ...
    run_cmd: "/usr/local/ruby-3.4.5/bin/ruby script.rb"
  },
  {
    id: 74,
  ...
  {
    id: 79,
    name: "Objective-C (Clang 14.0",
    is_archived: false,
    source_file: "main.m",
    compile_cmd: "/usr/bin/clang `gnustep-config --objc-flags | sed 's/-W[^ ]* //g'` `gnustep-config --base-libs | sed 's/-shared-libgcc//'` -I/usr/lib/gcc/x86_64-linux-gnu/8/include main.m %s",
    run_cmd: "./a.out"
  },
  # {
  #   id: 80,
